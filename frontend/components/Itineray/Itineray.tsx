...
`;
  ...
  if (!itinerary) {
    return (
      <div className="p-4 dark:bg-gray-900 dark:text-white">
        <p>No itinerary data available. Please try again later.</p>
      </div>
    );
  }
        ...
        <Card className="mb-6 overflow-hidden shadow-lg dark:bg-gray-800">
          ...
          <CardContent className="p-4 dark:text-gray-300">
            <p className="mb-2">
              ...
              {itinerary.trip_details.hotel}
            </p>
            <p className="mb-2">
              <span className="font-semibold">Check-in:</span>{" "}
              {itinerary.trip_details.check_in_date}
            </p>
            <p className="mb-2">
              <span className="font-semibold">Check-out:</span>{" "}
              {itinerary.trip_details.check_out_date}
            </p>
          </CardContent>
        </Card>
                ...
                <Card className="overflow-hidden shadow-md dark:bg-gray-800">
                  <CardContent className="p-4 dark:text-gray-300">
                    ...
                    {dayData.activities.map((activity, index) => (
                      <div
                        key={index}
                        className="mb-4 pb-4 border-b last:border-b-0 dark:border-gray-700"
                      >
                    ...
                    {/* <h4 className="font-bold text-xl mt-6 mb-3 text-blue-600 dark:text-blue-400">
                      Dining:
                    </h4> */}
                    {/* <p className="mb-2">
